...
const projects: Project[] = [
  {
    title: 'Smart Elderly Care & Patient Deterioration Surveillance',
    description: 'AI-powered healthcare surveillance platform combining Computer Vision, IoT sensing, and predictive analytics. Non-contact respiratory-rate estimation, real-time risk scoring, and clinical decision support. Institution-funded (~₹3 Lakhs).',
    image: 'https://images.unsplash.com/photo-1576091160550-2173dba999ef?w=800',
    tags: ['Python', 'Flask', 'CV', 'IoT', 'Healthcare AI'],
    github: 'https://github.com/Saiprasath-12',
    accent: '#00d4ff',
  },
  {
    title: 'AgriChain-Nizamabad',
    description: 'Blockchain-enabled agricultural traceability platform delivering farm-to-consumer transparency with QR-based verification and lifecycle tracking. Presented at BITS Pilani Hyderabad.',
    image: 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=800',
    tags: ['Next.js', 'React', 'TypeScript', 'Blockchain'],
    github: 'https://github.com/Saiprasath-12/AgriChain-Nizamabad',
    accent: '#22c55e',
  },
  {
    title: 'Society Finance Management',
    description: 'Full-stack financial management platform supporting expense tracking, complaint handling, member management, and role-based authentication for residential societies.',
  ...
  {
    title: 'Mentis AI',
    description: 'AI-powered adaptive learning platform delivering personalized learning experiences through intelligent recommendations built as a Progressive Web App.',
  ...
  },
  {
    ...
    description: 'Full-stack NLP web application built with Flask and React to classify news articles as real or fake using TF-IDF and machine learning models.',
  ...
  {
    title: 'Virus Hunter',
    description: 'Antivirus simulation implementing signature-based scanning logic to identify malware payloads in a modular architecture.',
